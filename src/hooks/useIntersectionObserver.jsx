...
/**
 * ARGUMENTS DESC:
 * elementRef: reference of target element whose visibility has to be observed.
 *
 * callback: called when element enters into /leaves from screen from top or bottom.
 *
 * rootRef:
 ...
 * Credits of hook: https://usehooks-ts.com/react-hook/use-intersection-observer
 */
